...
const AdSearch = () => {
    ...
    return (
        <form className='h-[53px] mb-[53px] relative' onSubmit={handleSubmit}>
            <input value={searchKeywordPlaceholder} onChange={e => setSearchKeywordPlaceholder(e.target.value)} className='block w-full p-4 text-sm text-gray-900 border-b focus:outline-none' placeholder='Search' />
